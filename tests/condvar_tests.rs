...
/// Timeout for condvar tests to prevent hanging
const CONDVAR_TEST_TIMEOUT: Duration = Duration::from_secs(10);

#[compio::test]
async fn test_condvar_basic_wait_notify() {
    let result = compio::time::timeout(CONDVAR_TEST_TIMEOUT, async {
